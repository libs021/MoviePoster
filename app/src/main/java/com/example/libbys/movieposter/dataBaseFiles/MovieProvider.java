...
public class MovieProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        db = new movieHelper(this.getContext());
        return true;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            case MOVIE:
                ...
                break;
            case VIDEOS:
                Table_name = movieContract.videoEntry.TABLE_NAME;
                break;
            case REVIEWS:
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        switch (sUriMatcher.match(uri)) {
            case MOVIE:
                rowID = database.insert(movieContract.movieEntry.TABLE_NAME,null,values);
               break;
            case REVIEWS:
                rowID = database.insert(movieContract.reviewEntry.TABLE_NAME,null,values);
                //No need to notify as if you are inserting a favorite than the list of favorites isn't on screen
                break;
            case VIDEOS:
                rowID = database.insert(movieContract.videoEntry.TABLE_NAME,null,values);
                //No need to notify as if you are inserting a favorite than the list of favorites isn't on screen
        }
     ...
     * @param selectionArgs Arguments that go with Selection
     * @return The number of rows affected.
     */
    @Override
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        //Only support deleting Movies;
        SQLiteDatabase database = db.getWritableDatabase();
        database.delete(movieContract.movieEntry.TABLE_NAME,selection,selectionArgs);
        selection = movieContract.reviewEntry.COLUMN_MOVIEID + "=?";
        //remove now orphened records from the review table selections args doesn't change because it is
