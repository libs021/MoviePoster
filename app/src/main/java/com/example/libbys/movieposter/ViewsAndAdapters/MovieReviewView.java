...
public class MovieReviewView extends RecyclerView.Adapter<MovieReviewView.ReviewHolder> {


    private ArrayList<MovieReview> mReviews;

    public MovieReviewView (ArrayList<MovieReview> reviews) {
        mReviews = reviews;
    }
    ...
    public ReviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View root = inflater.inflate(R.layout.layout_reviews, parent, false);
    ...
    public void onBindViewHolder(@NonNull ReviewHolder holder, int position) {
        holder.user.setText(mReviews.get(position).getmUser());
        holder.review.setText(mReviews.get(position).getmReview());
